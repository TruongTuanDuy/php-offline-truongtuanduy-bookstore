...
$inputName		= @Helper::cmsInput('text', 'form[fullname]', 'name', $dataForm['fullname'], 'inputbox required', 40);
$inputOrdering	= @Helper::cmsInput('text', 'form[ordering]', 'ordering', $dataForm['ordering'], 'inputbox', 40);
$inputScore	= @Helper::cmsInput('text', 'form[score]', 'score', $dataForm['score'], 'inputbox', 40);
