...
$inputLink	= @Helper::cmsInput('text', 'form[link]', 'link', $dataForm['link'], 'inputbox', 40);
...
// $selectLink	= @Helper::cmsSelectbox('form[link]', null, array('default' => '- Select rss acp -', 1 => 'Yes', 0 => 'No'), $dataForm['link'], 'width: 150px');
