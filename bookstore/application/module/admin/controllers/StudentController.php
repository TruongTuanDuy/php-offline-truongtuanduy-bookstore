...
class StudentController extends Controller
{
	...
	public function formAction()
	{
		...
		if (@$this->_arrParam['form']['token'] > 0) {
			...
			$validate->addRule('fullname', 'string', array('min' => 3, 'max' => 255))
				...
				->addRule('score', 'status', array('deny' => array('default')))
	...
	// ACTION: AJAX STUDENT ACP (*)
	public function ajaxACPAction()
	{
		$result = $this->_model->changeStatus($this->_arrParam, array('task' => 'change-ajax-student-acp'));
		echo json_encode($result);
	}
	...
	public function statusAction()
	{
		...
		URL::redirect('admin', 'student', 'index');
	}
